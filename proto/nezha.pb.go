...
func (x *DiscoverServerRequest) GetDiscoverKey() string {
	if x != nil {
		return x.DiscoverKey
	}
	return ""
}
...
type DiscoverServerResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	NewServerSecret string                 `protobuf:"bytes,1,opt,name=new_server_secret,json=newServerSecret,proto3" json:"new_server_secret,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *DiscoverServerResponse) GetNewServerSecret() string {
	if x != nil {
		return x.NewServerSecret
	}
	return ""
}
...
const file_proto_nezha_proto_rawDesc = "" +
	"\n" +
	"\x11proto/nezha.proto\x12\x05proto\":\n" +
	"\x15DiscoverServerRequest\x12!\n" +
	"\fdiscover_key\x18\x01 \x01(\tR\vdiscoverKey\"D\n" +
	...
	"\fcountry_code\x18\x02 \x01(\tR\vcountryCode2\x90\x03\n" +
	"\fNezhaService\x123\n" +
	...
	"\vLookupGeoIP\x12\f.proto.GeoIP\x1a\f.proto.GeoIP\"\x00\x12O\n" +
	"\x0eDiscoverServer\x12\x1c.proto.DiscoverServerRequest\x1a\x1d.proto.DiscoverServerResponse\"\x00B\tZ\a./protob\x06proto3"
...
var file_proto_nezha_proto_goTypes = []any{
	(*DiscoverServerRequest)(nil),   // 0: proto.DiscoverServerRequest
	(*DiscoverServerResponse)(nil),  // 1: proto.DiscoverServerResponse
	(*Host)(nil),                    // 2: proto.Host
	(*State)(nil),                   // 3: proto.State
	(*State_SensorTemperature)(nil), // 4: proto.State_SensorTemperature
	(*Task)(nil),                    // 5: proto.Task
	(*TaskResult)(nil),              // 6: proto.TaskResult
	(*Receipt)(nil),                 // 7: proto.Receipt
	(*IOStreamData)(nil),            // 8: proto.IOStreamData
	(*GeoIP)(nil),                   // 9: proto.GeoIP
}
var file_proto_nezha_proto_depIdxs = []int32{
	4, // 0: proto.State.temperatures:type_name -> proto.State_SensorTemperature
	3, // 1: proto.NezhaService.ReportSystemState:input_type -> proto.State
	2, // 2: proto.NezhaService.ReportSystemInfo:input_type -> proto.Host
	6, // 3: proto.NezhaService.ReportTask:input_type -> proto.TaskResult
	2, // 4: proto.NezhaService.RequestTask:input_type -> proto.Host
	8, // 5: proto.NezhaService.IOStream:input_type -> proto.IOStreamData
	9, // 6: proto.NezhaService.LookupGeoIP:input_type -> proto.GeoIP
	0, // 7: proto.NezhaService.DiscoverServer:input_type -> proto.DiscoverServerRequest
	7, // 8: proto.NezhaService.ReportSystemState:output_type -> proto.Receipt
	7, // 9: proto.NezhaService.ReportSystemInfo:output_type -> proto.Receipt
	7, // 10: proto.NezhaService.ReportTask:output_type -> proto.Receipt
	5, // 11: proto.NezhaService.RequestTask:output_type -> proto.Task
	8, // 12: proto.NezhaService.IOStream:output_type -> proto.IOStreamData
	9, // 13: proto.NezhaService.LookupGeoIP:output_type -> proto.GeoIP
	1, // 14: proto.NezhaService.DiscoverServer:output_type -> proto.DiscoverServerResponse
