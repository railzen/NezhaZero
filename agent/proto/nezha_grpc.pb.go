...
const (
	...
	NezhaService_DiscoverServer_FullMethodName    = "/proto.NezhaService/DiscoverServer"
)
...
func (c *nezhaServiceClient) DiscoverServer(ctx context.Context, in *DiscoverServerRequest, opts ...grpc.CallOption) (*DiscoverServerResponse, error) {
	out := new(DiscoverServerResponse)
	err := c.cc.Invoke(ctx, NezhaService_DiscoverServer_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedNezhaServiceServer) DiscoverServer(context.Context, *DiscoverServerRequest) (*DiscoverServerResponse, error) {
...
func _NezhaService_DiscoverServer_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DiscoverServerRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(NezhaServiceServer).DiscoverServer(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: NezhaService_DiscoverServer_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(NezhaServiceServer).DiscoverServer(ctx, req.(*DiscoverServerRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var NezhaService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _NezhaService_DiscoverServer_Handler,
		},
	},
